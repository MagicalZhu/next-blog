...
# 参考
1. [Java8-函数编程(lambda表达式)](https://pdai.tech/md/java/java8/java8-stream.html)
2. [java8-tutorial](https://github.com/aalansehaiyang/java8-tutorial)
