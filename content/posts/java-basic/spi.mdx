...
- <RefLink src="https://pdai.tech/md/java/advanced/java-advanced-spi.html">Java常用机制 - SPI机制详解</RefLink>
- <RefLink src="https://www.cnblogs.com/happyframework/archive/2013/09/17/3325560.html">设计原则：小议 SPI 和 API</RefLink>
